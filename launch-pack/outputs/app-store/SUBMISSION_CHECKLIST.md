...
- Resolve the App Store version `1.0` versus build marketing version `0.1.0` mismatch.
...
- Complete App Privacy only after the provider-scope decision in `APP_PRIVACY.md`.
