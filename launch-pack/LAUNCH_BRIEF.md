...
- Version: 0.1.0
- Build: 1
- Release state: Build uploaded and selectable; metadata and owner decisions remain
- Release date or window: After App Review approval
- Authoritative source: PR #30 at commit 06946dd plus App Store Connect build 0.1.0 (1)
...
- Primary call to action: Download Sorting Hat from the Mac App Store
...
- Included channels: Mac App Store product page, screenshots, icon handoff, privacy policy, support page, App Review notes, submission checklist
...
- Publication authority: Tom Ballard performs all App Store Connect edits and submission actions

## Evidence summary

- Release artifact or verified build: App Store Connect shows selectable build 0.1.0 (1) with an included App Icon
- Tests and measurements: PR #30 CI is green; Store archive and selected build were previously verified
- Specification and acceptance criteria: Issue #29 and docs/distribution.md
- Build logs and decisions: PR #30 history and App Store Connect read-only audit on 20 July 2026
